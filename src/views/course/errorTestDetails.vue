        ...
        <div class="topic" v-for="(item, index) in testList" :key="index">
          ...
          >
            ...
            <p
              ...
              "
            >
              解析：{{ item.yibei_requestion_const.answeranalysis }}
            </p>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      getUrl: {
        1: "/course/getmembererrorrequesttestbyid",
        2: "/course/getmemberallerrorrequesttestbyid",
        3: "/course/getmembercomprehensivetestbyid",
        5: "/course/getmembercomprehensivetestbyid",
      },

      getDetailsUrl: {
        1: "/course/getmembererrorquestdetail",
        2: "/course/getmemberallerrorrequesttestdetail",
        3: "/course/getmembercomprehensivedetail",
        5: "/course/getmembercomprehensivedetail",
      },
  ...
  methods: {
    ...
    async queryInfo() {
      ...
      const { data: resData } = await this.$get(this.getUrl[this.type], {
        params: {
          id: this.params.id,
        },
      });
    ...
    async queryTestList() {
      ...
      const { data: resData } = await this.$get(this.getDetailsUrl[this.type], {
        params: {
